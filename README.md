...
|           [evaluate](https://CRAN.R-project.org/package=evaluate)           |   0.10.1    |          Parsing and Evaluation Tools that Provide More Details than the           |
|                                   Default                                   |             |
...
|            [leaflet](https://CRAN.R-project.org/package=leaflet)            |    2.0.0    |             Create Interactive Web Maps with the JavaScript ‘Leaflet’              |
|                                   Library                                   |             |
...
|            [openssl](https://CRAN.R-project.org/package=openssl)            |    1.0.1    |            Toolkit for Encryption, Signatures and Certificates Based on            |
|                                   OpenSSL                                   |             |
...
|            [remotes](https://CRAN.R-project.org/package=remotes)            |    1.1.1    |             R Package Installation from Remote Repositories, Including             |
|                                  ‘GitHub’                                   |             |
...
| [rnaturalearthhires](https://CRAN.R-project.org/package=rnaturalearthhires) |    0.1.0    |          High Resolution World Vector Map Data from Natural Earth used in          |
|                                rnaturalearth                                |             |
